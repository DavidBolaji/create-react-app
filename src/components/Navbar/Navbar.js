    ...
    <>
        ...
        <div className={`desktop__links ${transparent && "active"}`}>
          ...
          >
            ...
            <div className={`dropdown__group ${dropdown && "active"}`}>
              <div>
                <Link to="/tec_in_every_home">Tec in every home</Link>
              </div>
              <div>
                <Link to="/tec_in_every_school">Tec in every School</Link>
              </div>
              <div>
                <Link to="/tec_in_every_community">Tec in every Community</Link>
              </div>
            </div>
          </div>
          <div className="main">
      ...
      <div className="navbar">
        <div className="navbar_menu" onClick={handleClick}>
          <HiMenuAlt1 color="#033462" fontSize="20px" />
        </div>
      ...
      <div
        className={`navbar__backdrop ${nav && "active"}`}
        onClick={handleClick}
      ></div>
    </>
  );
