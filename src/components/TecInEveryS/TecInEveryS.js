  ...
  return (
    <div className="tec__in__every__s">
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="500">
        ...
        that privilege Raphael O. Ajiboye "<br />
        <br />
        Esteemed Sir/Ma, glad you’re here! TEC IN EVERY SCHOOL was created just
        for you!
      </p>
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="500">
        ...
        foster a love of learning that every student/pupil needs.
      </p>
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="500">
        ...
        innovative ways to cultivate critical thinking and analytical skills as
        we form today’s instruction methods to fit your vision and the needs of
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="500">
        ...
        we have the power to inspire brilliance and ignite the passions of each
        student / pupil, taking them into their desired future.
      </p>
