  ...
  return (
    <div className="tec__in__every__h">
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="1500">
        ...
        success.Raphael O. Ajiboye "<br />
        <br />
        We’re excited to help empower TEC parents and TEC students to be active,
        engaged partners in learning, offering new ways to personalize how
        schools teach and inspire today’s students
      </p>
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="1500">
        ...
        not to be meeting their children needs, especially a child’s specific
        need. With rich and averagely rich parents saying the same thing about
        their children struggles and how they need one on one attention, which
        no school can provide even if they’ve 5 students in a class, knowing
        every child learn at different pace and that the routine of “hiding
        curriculum” which make education passive and test focus require new
        approach.
      </p>
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="1500">
        ...
        foster a love of learning that extends far beyond the average school
        classroom. Because we know that teachers who keep learning help build a
      ...
      <p className="a_para" data-aos="fade-in" data-aos-duration="1500">
        ...
        today’s instruction methods to fit the needs of tomorrow’s workplaces.
      </p>
